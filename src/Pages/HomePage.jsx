  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-gray-950 from-10% via-gray-900 via-30% to-slate-950 to-90%'>
        <section className="flex flex-col items-center justify-center text-center py-20 px-4 md:py-32">
          ...
          <button onClick={()=>{navigate('/create')}} className="bg-indigo-200 text-xl md:text-2xl bitcount-grid-double-title leading-tight p-3 text-white py-3 px-8 rounded-full shadow-lg hover:bg-indigo-700 transition duration-300 transform hover:scale-105 ">
            Create your first invoice..
          </button>
        </section>
        <div className='flex mt-9'>
            <div className='m-7 p-5 hover:border-l-5 hover:border-l-gray-900 transition duration-900 transform'>
            ...
            <div className='my-7 mr-7 p-5 transition duration-900 transform hover:border-l-5 hover:border-l-slate-800 '>
            ...
            <div className='my-7 mr-7 p-5 hover:border-l-5 hover:border-l-gray-900 transition duration-900 transform'>
